...
export const dailyChallengeTemplates: ChallengeTemplate[] = [
  { id: 'daily-hiragana', alphabetId: 'jp-hiragana', labelKey: 'challenges.hiragana', xpReward: 50, targetCount: 46 },
  { id: 'daily-katakana', alphabetId: 'jp-katakana', labelKey: 'challenges.katakana', xpReward: 50, targetCount: 46 },
  { id: 'daily-kanji-30', alphabetId: 'jp-kanji', labelKey: 'challenges.kanji30', xpReward: 80, targetCount: 30 },
];
...
export function getTodayTargetChars(template: ChallengeTemplate, dateSeed: string, level: number): string[] {
  ...
  const pool = template.alphabetId === 'jp-kanji' ? getUnlockedKanji(level) : alphabet.entries;
